...
namespace Suddath.Helix.JobMgmt.Models
{
    public static class NameTranslator
    {
        ...
        public static Dictionary<string, string> repo = new Dictionary<string, string>
        {
            ...
            {"BINGO","Bingo Bell"},
            {"JAMESB","James Bell"},
            {"PETERB","Peter A Bowsher"},
            {"Peter Bowsher","Peter A Bowsher"},
            ...
            {"MWILSON","Mike Wilson"},
            {"LNASSAU","Lita Nassau"},
            {"LSHEFFIELD","Lindsey B Sheffield"},
            {"Lindsey Sheffield","Lindsey B Sheffield"},
            {"ROSIEL","Rosie Lara"},
            {"CSITZ","Carissa Sitz"},
            ...
            {"TGLEASON","Teela J Gleason"},
            {"Teela Gleason","Teela J Gleason"},
