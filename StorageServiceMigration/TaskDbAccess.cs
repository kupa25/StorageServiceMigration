...
namespace StorageServiceMigration
{
    public static class TaskDbAccess
    {
        ...
        public static string connectionString = @"data source=paue2helix3sql01.database.windows.net;initial catalog=Helix3.Tasks;User ID=helix3_app;Password=V$@h@ERZnrDFGvZ9; Connect Timeout=120;MultipleActiveResultSets=True;";
